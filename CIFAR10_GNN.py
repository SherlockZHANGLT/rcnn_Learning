...
def resnet_graph(input_image, architecture,train_flag=True, stage5=False,ttf=True):  # 残差网络函数
    ...
    #x=GroupNorm(x)
    x = GroupNormaliztion(x=data, is_training=True, groups=8)
...
model_save_path='./save/cifar10/GNN'
...
#保存模型
save_path = saver.save(sess,"./save/cifar10/GNN/model.ckpt")
print("save model:{0} Finished".format(save_path))
np.save("./save/cifar10/GNN/cifar10_step",total_step)
np.save("./save/cifar10/GNN/cifar10_loss",total_loss)
np.save("./save/cifar10/GNN/cifar10_acc",total_acc)
np.save("./save/cifar10/GNN/cifar10_ap",total_ap)
...
np.save("./save/cifar10/GNN/cifar10_precision_score",ps)

#召回率
from sklearn.metrics import recall_score
rs=recall_score(y_test, y_log_predict,average=None)
np.save("./save/cifar10/GNN/cifar10_recall_score",rs)
