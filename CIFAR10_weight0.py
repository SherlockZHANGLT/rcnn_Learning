...
def weight_variable(shape):
    weights = tf.get_variable("weights", shape, initializer=tf.constant_initializer(0.0))
    #加入l2正则化
...
model_save_path='./save/cifar10/weight0'
...
#保存模型
save_path = saver.save(sess,"./save/cifar10/weight0/model.ckpt")
print("save model:{0} Finished".format(save_path))
np.save("./save/cifar10/weight0/cifar10_step",total_step)
np.save("./save/cifar10/weight0/cifar10_loss",total_loss)
np.save("./save/cifar10/weight0/cifar10_acc",total_acc)
np.save("./save/cifar10/weight0/cifar10_ap",total_ap)
...
np.save("./save/cifar10/weight0/cifar10_precision_score",ps)

#召回率
from sklearn.metrics import recall_score
rs=recall_score(y_test, y_log_predict,average=None)
np.save("./save/cifar10/weight0/cifar10_recall_score",rs)
